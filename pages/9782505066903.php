    ...
    <main>
      ...
      <div class="content">
        ...
        <div class="text">
        	...
        	<ul>
        		<li><strong>Éditeur VF :</strong> Kana (Dark Kana)</li>
        		<li><strong>Éditeur VO :</strong> Kodansha</li>
        		<li><strong>Date de parution VO :</strong> 09/05/2014</li>
        		<li><strong>Date de parution VF :</strong> 08/07/2016</li>
        		<li><strong>Prix :</strong> 7.45 € / 605 ¥</li>
        		<li><strong>Nombre de pages :</strong> 192</li>
        		<li><strong>Illustrations :</strong> N&B</li>
        		<li><strong>Code ISBN :</strong> 9782505066903</li>
        		<li><strong>Scénariste :</strong> Miura Tsuina</li>
        		<li><strong>Dessinateur :</strong> Oba Takahiro</li>
