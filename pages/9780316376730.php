    ...
    <main>
      ...
      <div class="content">
        ...
        <div class="text">
        	...
        	<ul>
        		<li><strong>Éditeur VF :</strong> Ototo (Ototo - Shonen)</li>
        		<li><strong>Éditeur VO :</strong> ASCII Media Works</li>
        		<li><strong>Date de parution VO :</strong> 27/07/2011</li>
        		<li><strong>Date de parution VF :</strong> 22/05/2015</li>
        		<li><strong>Prix :</strong> 6.99 € / 599 ¥</li>
        		<li><strong>Nombre de pages :</strong> 192</li>
        		<li><strong>Illustrations </strong>: N&B</li>
        		<li><strong>Code ISBN :</strong> 9780316376730</li>
        		<li><strong>Scénariste :</strong> Kawahara Reki</li>
        		<li><strong>Dessinateur :</strong> Aigamo Hiroyuki</li>
