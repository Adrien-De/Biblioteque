    ...
    <main>
      ...
      <div class="content">
        ...
        <div class="text">
        	...
        	<ul>
        		<li><strong>Éditeur VF :</strong> Kana (Kana - Shonen)</li>
        		<li><strong>Éditeur VO :</strong> Shueisha</li>
        		<li><strong>Date de parution VO :</strong> 05/01/2009</li>
        		<li><strong>Date de parution VF :</strong> 02/07/2010</li>
        		<li><strong>Prix :</strong> 6.85 € / 420 ¥</li>
        		<li><strong>Nombre de pages :</strong> 192</li>
        		<li><strong>Illustrations :</strong> N&B</li>
        		<li><strong>Code ISBN :</strong> 9782505008262</li>
        		<li><strong>Scénariste :</strong> Ohba Tsugumi</li>
        		<li><strong>Dessinateur :</strong> Obata Takeshi</li>
            <li><strong>Traducteur :</strong> Thibaud Desbief</li>
