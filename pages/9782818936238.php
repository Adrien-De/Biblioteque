    ...
    <main>
      ...
      <div class="content">
        ...
        <div class="text">
        	...
        	<ul>
        		<li><strong>Éditeur VF :</strong> Doki-Doki (Doki-Doki - Seinen)</li>
        		<li><strong>Éditeur VO :</strong> Media Factory</li>
        		<li><strong>Date de parution VO :</strong> 23/06/2014</li>
        		<li><strong>Date de parution VF :</strong> 01/06/2016</li>
        		<li><strong>Prix :</strong> 7.50 € / 595 ¥</li>
        		<li><strong>Nombre de pages :</strong> 192</li>
        		<li><strong>Illustrations :</strong> N&B</li>
        		<li><strong>Code ISBN :</strong> 9782818936238</li>
        		<li><strong>Scénariste :</strong> Aneko Yusagi</li>
        		<li><strong>Dessinateur :</strong> Aiya Kyu</li>
            <li><strong>Chara-designer :</strong> Minami Seira</li>
