      ...
      <div class="content">
        ...
        <div class="text">
            ...
            <li><strong>PAS SORTIE EN FRANCE</strong></li>
        		...
        		<li><strong>Date de parution VO :</strong> 02/02/2018</li>
        		<li><strong>Prix :</strong> 702 ¥</li>
        		<li><strong>Nombre de pages :</strong> 188</li>
        		<li><strong>Illustrations :</strong> N&B</li>
        		<li><strong>Scénariste :</strong> Code:000</li>
        		<li><strong>Dessinateur :</strong> Yabuki Kentaro</li>
