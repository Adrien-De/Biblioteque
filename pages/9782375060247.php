    ...
    <main>
      ...
      <div class="content">
        ...
        <div class="text">
        	...
        	<ul>
        		<li><strong>Éditeur VF :</strong> Ototo (Ototo - Seinen)</li>
        		<li><strong>Éditeur VO :</strong> Kadokawa Shoten</li>
        		<li><strong>Date de parution VO :</strong> 26/06/2015</li>
        		<li><strong>Date de parution VF :</strong> 20/01/2017</li>
        		<li><strong>Prix :</strong> 7.99 € / 626 ¥</li>
        		<li><strong>Nombre de pages :</strong> 192</li>
        		<li><strong>Illustrations :</strong> N&B</li>
        		<li><strong>Code ISBN :</strong> 9782375060247</li>
        		<li><strong>Scénariste :</strong> Oshio Satoshi</li>
        		<li><strong>Dessinateur :</strong> Miyama Fugin</li>
            <li><strong>Auteur original :</strong> Maruyama Kugane</li>  
            <li><strong>Chara-designer :</strong> so-bin</li>
