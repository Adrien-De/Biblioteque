    ...
    <main>
      ...
      <div class="content">
        ...
        <div class="text">
        	...
        	<ul>
        		<li><strong>Éditeur VF :</strong> Kazé (Kazé - Shônen)</li>
        		<li><strong>Éditeur VO :</strong> Shueisha</li>
        		<li><strong>Date de parution VO :</strong> 04/06/2012</li>
        		<li><strong>Date de parution VF :</strong> 03/01/2014</li>
        		<li><strong>Prix :</strong> 6.79 € / 432 ¥</li>
        		<li><strong>Nombre de pages :</strong> 192</li>
        		<li><strong>Illustrations :</strong> N&B</li>
        		<li><strong>Code ISBN :</strong> 9782820316585</li>
            <li><strong>Auteur :</strong> Furudate Haruichi</li>  
