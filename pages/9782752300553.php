    ...
    <main>
      ...
      <div class="content">
        ...
        <div class="text">
        	...
        	<ul>
        		<li><strong>Éditeur VF :</strong> Kabuto</li>
        		<li><strong>Éditeur VO :</strong> Shonen Gahosha</li>
        		<li><strong>Date de parution VO :</strong> 25/04/1997</li>
        		<li><strong>Date de parution VF :</strong> 18/10/2005</li>
        		<li><strong>Prix :</strong> 6.90 € / 530 ¥</li>
        		<li><strong>Nombre de pages :</strong> 192</li>
        		<li><strong>Illustrations :</strong> N&B</li>
        		<li><strong>Code ISBN :</strong> 9782752300553</li>
            <li><strong>Auteur :</strong> Rikudo Koshi</li>  
