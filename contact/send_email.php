...
if (isset($_POST['envoye']))
{
    ...
    * vers la page d'accueil */
    if($_SERVER['HTTP_REFERER'] != 'http://localhost/biblio_groupe15_etape4/contact/send_email.php')
    {
      header('Location: http://localhost/biblio_groupe15_etape4/index.php');
    }
