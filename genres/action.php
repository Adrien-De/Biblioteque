...
<html>
  ...
  <body>
    ...
    <header>
       <a href="../index.php"><img class="logo" src="../Logo2.0.png" alt="Image" /></a>
      ...
      <div class="container">
        <div class="genre">
        <h2>Action :</h2> <p>En manga d'action, on trouve traditionnellement les genres masculins du shonen manga et du seinen manga dans lesquels beaucoup de scène de combat et d'action prédominent.</p>
        </div>
